...
public class FallbackController {
    ...
    public String getFallbackResponse(@RequestBody FallbackModel requestModel) throws JsonProcessingException {
        ...
        log.info(String.format(String.format("Failure msg : %s", requestModel.getFailureMessage())));
        log.info(String.format(String.format("Failure request type : %s", requestModel.getRequestType())));
        log.info(String.format("Failed request body : %s", mapper.writeValueAsString(requestModel.getRequestBody())));
